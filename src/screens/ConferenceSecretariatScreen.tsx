...
const visitUrl = 'https://events.ntpc.co.in/noshe';
const contactEmail = 'noshe@ntpc.co.in';
...
export function ConferenceSecretariatScreen() {
  return (
    <Screen>
      ...
      <View style={styles.infoCards}>
        ...
        >
          <View style={styles.infoIcon}>
            <Ionicons name="globe-outline" size={21} color={theme.colors.orange} />
          </View>
          <View style={styles.infoCopy}>
            <Text style={styles.infoLabel}>Website</Text>
            <Text style={styles.infoValue}>{visitUrl}</Text>
          </View>
        ...
        >
          <View style={styles.infoIcon}>
            <Ionicons name="mail-outline" size={21} color={theme.colors.orange} />
          </View>
          <View style={styles.infoCopy}>
